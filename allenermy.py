            ...
            if self.counter == 100:
                if self.walkCount2 < 134:
                    ...
                    if not self.mute and self.walkCount2 == 4:
                        pygame.mixer.Channel(2).play(self.TransformSound)
                    if not self.mute and self.walkCount2 == 100:
                        pygame.mixer.Channel(2).play(self.DragonSound)
                else:
                    self.counter = -1
            if self.cba == 1000:
                self.walk = False
                ...
                if self.attackCount < 84:
                    ...
                    if not self.mute and self.attackCount == 2:
                        pygame.mixer.Channel(2).play(self.DragonAttackSound)
                    if not self.mute and self.attackCount == 62:
                        pygame.mixer.Channel(2).play(self.BigExplosionSound)
                        pygame.mixer.Channel(2).play(self.DragonSound)
